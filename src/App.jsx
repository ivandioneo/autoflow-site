...
// Never commit the real URL — rotate it in Activepieces if it was ever exposed.
const WEBHOOK_URL = import.meta.env.VITE_WEBHOOK_URL;
if (!WEBHOOK_URL) {
  throw new Error("[AutoFlow] VITE_WEBHOOK_URL is not set. Add it to Cloudflare Pages environment variables.");
}
...
function SavingsCalculator() {
  ...
  return (
    <div style={{
      ...
      {[
        ...
        <div key={i} style={{ marginBottom: 22 }}>
          <div style={{ display: "flex", justifyContent: "space-between", marginBottom: 8 }}>
            ...
            <span style={{ color: "#14B8A6", fontSize: 15, fontWeight: 800 }}>
      ...
      <div style={{
        marginTop: 12, background: "rgba(13,148,136,0.08)", borderRadius: 14, padding: "14px 16px",
        border: "1px solid rgba(13,148,136,0.15)", textAlign: "center",
      }}>
        <span style={{ color: "rgba(255,255,255,0.5)", fontSize: 12 }}>That's </span>
        <span style={{ color: "#14B8A6", fontSize: 22, fontWeight: 800 }}>{savedPerYear.toLocaleString()} AED</span>
  ...
  return (
    <div
      ...
      style={{
        ...
        border: highlight ? "1px solid rgba(13,148,136,0.3)" : "1px solid #E2E8F0",
        boxShadow: highlight
          ? hover ? "0 20px 60px rgba(13,148,136,0.18)" : "0 12px 40px rgba(15,23,42,0.3)"
    ...
    >
      {badge && (
        <div style={{
          background: "#0D9488",
          color: "white", fontWeight: 700, fontSize: 10, padding: "5px 14px",
    ...
    <>
      <button
        ...
        style={{
          ...
          color: "white", fontSize: 22, cursor: "pointer", padding: 4,
        }}
        className="hamburger"
      >
        {open ? "✕" : "☰"}
      ...
      {open && (
        <div style={{
          ...
          borderBottom: "1px solid rgba(255,255,255,0.06)", zIndex: 99,
        }}>
          {["#calc", "#how", "#pricing"].map((href, i) => (
            <a key={href} href={href} onClick={() => setOpen(false)}
              style={{ color: "rgba(255,255,255,0.8)", textDecoration: "none", fontWeight: 600, fontSize: 16 }}>
              {["Calculator", "How it works", "Pricing"][i]}
            </a>
          ))}
          <a href={dashUrl} style={{ color: "rgba(255,255,255,0.8)", textDecoration: "none", fontWeight: 600, fontSize: 16 }}>Log in</a>
    ...
    <div style={{ fontFamily: "'Inter', system-ui, sans-serif", color: "#334155", background: "#F0F4F8", overflowX: "hidden" }}>
      <style>{`
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        h1, h2.display { font-family: 'Instrument Serif', Georgia, serif; }
        /* Mobile nav */
      ...
      <nav style={{
        ...
        {/* Mobile hamburger */}
        <MobileNav dashUrl={DASHBOARD_URL} />
      </nav>
      ...
      <section style={{
        ...
        <div style={{
          ...
          borderRadius: "50%", background: "radial-gradient(circle, rgba(13,148,136,0.06) 0%, transparent 70%)",
          filter: "blur(50px)",
        }} />
        ...
        <div style={{
          ...
          <div style={{ flex: "1 1 420px", maxWidth: 540 }}>
            <div style={{
              ...
              <span style={{ color: "#14B8A6", fontSize: 12, fontWeight: 600, textTransform: "uppercase", letterSpacing: 0.5 }}>
            ...
            <h1 style={{
              ...
              fontSize: "clamp(2.5rem, 5vw, 3.5rem)", fontWeight: 400, color: "white",
              lineHeight: 1.08, letterSpacing: -0.5, marginBottom: 20,
            }}>
        ...
        <FadeIn>
          <div style={{ maxWidth: 1140, margin: "0 auto", display: "flex", flexWrap: "wrap", gap: 48, alignItems: "center", justifyContent: "center" }}>
            <div style={{ flex: "1 1 340px", maxWidth: 440 }}>
              <h2 className="display" style={{ fontFamily: "'Instrument Serif', Georgia, serif", fontSize: "clamp(1.75rem, 3vw, 2.25rem)", fontWeight: 400, color: "white", lineHeight: 1.2, letterSpacing: 0, marginBottom: 16 }}>
        ...
        <div style={{
          ...
          {[
            ...
            <div key={i} style={{ textAlign: "center", minWidth: 160 }}>
              <div style={{ fontFamily: "'Instrument Serif', Georgia, serif", fontSize: 42, fontWeight: 400, color: "#0F172A", letterSpacing: -0.5 }}>
        ...
        <FadeIn>
          <div style={{ maxWidth: 900, margin: "0 auto" }}>
            <div style={{ textAlign: "center", marginBottom: 48 }}>
              <h2 style={{ fontFamily: "'Instrument Serif', Georgia, serif", fontSize: "clamp(1.75rem, 3vw, 2.25rem)", fontWeight: 400, color: "#0F172A", letterSpacing: 0 }}>How it works</h2>
            ...
            <div style={{ display: "flex", flexWrap: "wrap", gap: 20, justifyContent: "center" }}>
              {[
                ...
                <div key={i} style={{
                  ...
                  <div style={{
                    fontSize: 11, fontWeight: 700, color: "#0D9488", letterSpacing: 1,
      ...
      <section style={{ padding: "72px 32px", background: "white" }}>
        <FadeIn>
          <div style={{ maxWidth: 1000, margin: "0 auto" }}>
            <h2 style={{ fontFamily: "'Instrument Serif', Georgia, serif", fontSize: "clamp(1.6rem, 2.5vw, 2rem)", fontWeight: 400, color: "#0F172A", textAlign: "center", marginBottom: 12 }}>
            ...
            <div style={{ display: "flex", flexWrap: "wrap", gap: 16, justifyContent: "center" }}>
              {[
                ...
                <div key={i} style={{
                  ...
                  <div style={{ fontFamily: "'Instrument Serif', Georgia, serif", fontSize: 24, fontWeight: 400, color: "#0D9488", marginBottom: 6 }}>{c.stat}</div>
        ...
        <FadeIn>
          <div style={{ maxWidth: 1060, margin: "0 auto" }}>
            <div style={{ textAlign: "center", marginBottom: 44 }}>
              <h2 style={{ fontFamily: "'Instrument Serif', Georgia, serif", fontSize: "clamp(1.75rem, 3vw, 2.25rem)", fontWeight: 400, color: "#0F172A" }}>Simple, honest pricing</h2>
        ...
        <FadeIn>
          <div style={{
            ...
            <div style={{ flex: 1, minWidth: 280 }}>
              <div style={{ fontFamily: "'Instrument Serif', Georgia, serif", fontWeight: 400, fontSize: 20, color: "white", marginBottom: 6 }}>
        ...
        <FadeIn>
          <div style={{ maxWidth: 560, margin: "0 auto" }}>
            <div style={{ textAlign: "center", marginBottom: 36 }}>
              <h2 style={{ fontFamily: "'Instrument Serif', Georgia, serif", fontSize: "clamp(1.75rem, 3vw, 2.25rem)", fontWeight: 400, color: "#0F172A" }}>
            ...
            {submitted ? (
              <div style={{
                ...
                <div style={{ fontFamily: "'Instrument Serif', Georgia, serif", fontSize: 24, fontWeight: 400, color: "#0F172A", marginBottom: 8 }}>
                  You're in!
                </div>
