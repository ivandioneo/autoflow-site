...
function SavingsCalculator() {
  ...
  return (
    <div style={{
      ...
      borderRadius: 24, padding: "clamp(24px,4vw,40px) clamp(20px,3vw,32px)",
      ...
      <h3 style={{
        ...
        fontWeight: 400, marginBottom: 4, letterSpacing: -0.3,
      }}>
      ...
      {[
        ...
        <div key={i} style={{ marginBottom: 22 }}>
          <div style={{ display: "flex", justifyContent: "space-between", marginBottom: 8 }}>
            ...
            <span style={{ color: "#F59E0B", fontSize: "clamp(0.875rem, 1.8vw, 0.9375rem)", fontWeight: 800 }}>
      ...
      <div style={{
        ...
        <div style={{
          flex: 1, background: "rgba(239,68,68,0.1)", borderRadius: 14,
          ...
          <div style={{ color: "#EF4444", fontSize: "clamp(1.25rem, 3vw, 1.75rem)", fontWeight: 800, marginTop: 4 }}>
            {lostPerMonth.toLocaleString()} <span style={{ fontSize: "clamp(0.75rem, 1.5vw, 0.875rem)", fontWeight: 600 }}>AED/mo</span>
          </div>
        </div>
        <div style={{
          flex: 1, background: "rgba(16,185,129,0.1)", borderRadius: 14,
          padding: "clamp(12px,2vw,18px) 16px",
          ...
          <div style={{ color: "#10B981", fontSize: "clamp(1.25rem, 3vw, 1.75rem)", fontWeight: 800, marginTop: 4 }}>
            {savedPerMonth.toLocaleString()} <span style={{ fontSize: "clamp(0.75rem, 1.5vw, 0.875rem)", fontWeight: 600 }}>AED/mo</span>
          </div>
        </div>
      </div>
      <div style={{
        marginTop: 12, background: "rgba(245,158,11,0.08)", borderRadius: 14,
        padding: "14px 16px", border: "1px solid rgba(245,158,11,0.12)", textAlign: "center",
      }}>
        <span style={{ color: "rgba(255,255,255,0.5)", fontSize: "clamp(0.75rem, 1.5vw, 0.8125rem)" }}>That's </span>
        <span style={{ color: "#F59E0B", fontSize: "clamp(1.125rem, 3vw, 1.375rem)", fontWeight: 800 }}>{savedPerYear.toLocaleString()} AED</span>
        <span style={{ color: "rgba(255,255,255,0.5)", fontSize: "clamp(0.75rem, 1.5vw, 0.8125rem)" }}> saved per year</span>
      </div>
    </div>
  );
}
  ...
  return (
    <div
      ...
      style={{
        ...
        flex: highlight ? "0 0 300px" : "1 1 255px",
        maxWidth: highlight ? 320 : 300,
        border: highlight
          ? "1px solid rgba(245,158,11,0.4)"
          : "1px solid #E2E8F0",
        boxShadow: highlight
          ? hover
            ? "0 0 0 1px rgba(245,158,11,0.5), 0 24px 64px rgba(245,158,11,0.18), 0 12px 32px rgba(0,0,0,0.5)"
            : "0 0 0 1px rgba(245,158,11,0.25), 0 16px 48px rgba(245,158,11,0.12), 0 8px 24px rgba(0,0,0,0.4)"
          : hover
            ? "0 12px 32px rgba(0,0,0,0.08)"
            : "0 2px 8px rgba(0,0,0,0.04)",
        display: "flex", flexDirection: "column", gap: 16,
        transform: highlight
          ? hover ? "translateY(-10px) scale(1.02)" : "translateY(-4px) scale(1.04)"
    ...
    >
      ...
      <div style={{ display: "flex", alignItems: "baseline", gap: 4 }}>
        <span style={{
          ...
          fontFamily: "'Instrument Serif', Georgia, serif",
          fontWeight: 400, color: highlight ? "white" : "#0F172A", letterSpacing: -1,
        }}>{price}</span>
      ...
      <button
        ...
        style={{
          ...
          boxShadow: highlight && hover ? "0 8px 24px rgba(245,158,11,0.35)" : "none",
        }}
      >
        {ctaLabel}
      </button>
...
export default function AutoFlowLanding() {
  ...
  // E.164-style: optional +, 1-3 digit country code, 6-12 digits, total 7-15 digits
    ...
    <div style={{ fontFamily: "'Inter', system-ui, sans-serif", color: "#334155", background: "#F0F4F8", overflowX: "hidden" }}>
      <style>{`
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .timeline-step:not(:last-child)::after {
          ...
          width: calc(100% - 56px);
          height: 2px;
          background: linear-gradient(90deg, #0D9488 0%, rgba(13,148,136,0.15) 100%);
        }
        ...
        @media (prefers-color-scheme: dark) {
          .stats-section { background: #111827 !important; }
          .stats-section .stat-number { color: #F8FAFC !important; }
          .stats-section .stat-label { color: #94A3B8 !important; }
        }
      `}</style>
      ...
      <nav style={{
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
          ...
          <span style={{ fontWeight: 900, fontSize: "clamp(1rem, 2vw, 1.1875rem)", color: "white", letterSpacing: -0.5, fontFamily: "'Instrument Serif', Georgia, serif" }}>AutoFlow</span>
        </div>

        {/* Desktop links */}
        <div className="desktop-nav-links" style={{ display: "flex", gap: 24, alignItems: "center" }}>
          {navLinks.map(l => (
            <a key={l.href} href={l.href} className="nav-link" style={{ color: "rgba(255,255,255,0.6)", textDecoration: "none", fontWeight: 500, fontSize: "clamp(0.75rem, 1.5vw, 0.8125rem)", transition: "color 0.2s" }}>{l.label}</a>
          ))}
          <a href={DASHBOARD_URL} className="login-link" style={{
            color: "rgba(255,255,255,0.75)", textDecoration: "none", fontWeight: 600, fontSize: "clamp(0.75rem, 1.5vw, 0.8125rem)",
          ...
          <a href="#quote" style={{
            ...
            textDecoration: "none", fontWeight: 700, fontSize: "clamp(0.75rem, 1.5vw, 0.8125rem)",
        ...
        >
          {[0,1,2].map(i => (
            <span key={i} style={{
              display: "block", width: 22, height: 2, background: "white", borderRadius: 1,
              transition: "all 0.2s",
      ...
      <div className="mobile-nav-menu" style={{
        ...
        {navLinks.map(l => (
          <a key={l.href} href={l.href}
            ...
            style={{
              color: "white", textDecoration: "none", fontSize: "1.25rem",
              fontFamily: "'Instrument Serif', Georgia, serif",
              padding: "14px 0",
              borderBottom: "1px solid rgba(255,255,255,0.07)",
            }}>{l.label}</a>
        ))}
        <a href={DASHBOARD_URL} onClick={() => setMobileNavOpen(false)}
          style={{ color: "rgba(255,255,255,0.6)", textDecoration: "none", fontSize: "1rem", padding: "14px 0" }}>Log in</a>
        <a href="#quote" onClick={() => setMobileNavOpen(false)}
          style={{
            marginTop: 8, background: "#F59E0B", color: "white",
      ...
      <section style={{
        ...
        padding: "clamp(100px, 15vw, 140px) clamp(16px, 4vw, 32px) clamp(60px, 8vw, 80px)",
          ...
          <div style={{ flex: "1 1 420px", maxWidth: 540 }}>
            ...
            <div style={{ display: "flex", gap: 14, flexWrap: "wrap", marginBottom: 36 }}>
              <a href="#quote" style={{
                ...
                transition: "box-shadow 0.2s", display: "inline-block",
              }}>Request a Free Quote</a>
              <a href="#calc" style={{
                background: "rgba(255,255,255,0.05)", border: "1px solid rgba(255,255,255,0.1)",
                color: "white",
                padding: "clamp(12px,2vw,16px) clamp(16px,2.5vw,28px)",
                borderRadius: 14, textDecoration: "none", fontWeight: 600,
                fontSize: "clamp(0.875rem, 2vw, 0.9375rem)",
              }}>Calculate Your Savings ↓</a>
            </div>
            <div style={{ display: "flex", flexWrap: "wrap", gap: 16, fontSize: "clamp(0.75rem, 1.5vw, 0.8125rem)", color: "rgba(255,255,255,0.35)" }}>
      ...
      <section id="calc" style={{
        ...
        padding: "clamp(48px, 8vw, 72px) clamp(16px, 4vw, 32px) clamp(56px, 8vw, 80px)",
      }}>
        <FadeIn>
          <div style={{ maxWidth: 1140, margin: "0 auto", display: "flex", flexWrap: "wrap", gap: 48, alignItems: "center", justifyContent: "center" }}>
            <div style={{ flex: "1 1 300px", maxWidth: 440 }}>
              <h2 style={{
                ...
                fontFamily: "'Instrument Serif', Georgia, serif",
                fontWeight: 400, color: "white", lineHeight: 1.2, letterSpacing: -0.5, marginBottom: 16,
              }}>
                See exactly how much you're leaving on the table
              </h2>
              <p style={{ color: "rgba(255,255,255,0.4)", fontSize: "clamp(0.875rem, 1.8vw, 0.9375rem)", lineHeight: 1.7, marginBottom: 24 }}>
              ...
              <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
                {[
                  ...
                  <div key={i} style={{ display: "flex", gap: 12, alignItems: "center" }}>
                    ...
                    <span style={{ color: "rgba(255,255,255,0.6)", fontSize: "clamp(0.8125rem, 1.6vw, 0.875rem)" }}>{p.text}</span>
                  </div>
                ))}
              </div>
            </div>
      ...
      {/* ─── STATS ─── */}
      <section className="stats-section" style={{ background: "white", padding: "clamp(32px, 5vw, 48px) clamp(16px, 4vw, 32px)" }}>
        <div style={{ maxWidth: 900, margin: "0 auto", display: "flex", flexWrap: "wrap", justifyContent: "center", gap: "clamp(24px, 5vw, 48px)" }}>
          {[
            ...
            <div key={i} style={{ textAlign: "center", minWidth: 140 }}>
              <div className="stat-number" style={{ fontSize: "clamp(2rem, 5vw, 2.625rem)", fontFamily: "'Instrument Serif', Georgia, serif", fontWeight: 400, color: "#0F172A", letterSpacing: -1 }}>
                {s.n === 0 ? "0" : <Counter target={s.n} />}{s.s}
              </div>
              <div className="stat-label" style={{ fontSize: "clamp(0.75rem, 1.5vw, 0.8125rem)", color: "#94A3B8", marginTop: 4, fontWeight: 500 }}>{s.label}</div>
            </div>
          ))}
        </div>
      </section>
      ...
      <section id="how" style={{ padding: "clamp(56px, 8vw, 80px) clamp(16px, 4vw, 32px)", background: "#F8FAFC" }}>
        <FadeIn>
          <div style={{ maxWidth: 900, margin: "0 auto" }}>
            <div style={{ marginBottom: 48 }}>
              ...
              <p style={{ color: "#94A3B8", fontSize: "clamp(0.875rem, 1.8vw, 0.9375rem)", marginTop: 8 }}>
            ...
            <div style={{ display: "flex", flexWrap: "wrap", gap: 0, justifyContent: "space-between" }}>
              {[
                ...
                { num: "02", title: "Flow triggers", desc: "Our automation engine picks it up instantly — no delay, no manual entry needed.", accent: "#F59E0B" },
                ...
                { num: "04", title: "Everything logged", desc: "Dashboard shows confirmed, pending, no-shows. You see the full picture at a glance.", accent: "#F59E0B" },
              ].map((s, i) => (
                <div key={i} className="timeline-step" style={{
                  flex: "1 1 180px", maxWidth: 210, padding: "0 8px 32px",
                  position: "relative", textAlign: "left",
                }}>
                  {/* Step number circle */}
                  <div style={{
                    width: 48, height: 48, borderRadius: "50%",
                    background: s.accent === "#F59E0B" ? "rgba(245,158,11,0.1)" : "rgba(13,148,136,0.1)",
                    border: `2px solid ${s.accent}`,
                    display: "flex", alignItems: "center", justifyContent: "center",
                    marginBottom: 20,
                  }}>
                    <span style={{ fontSize: "0.75rem", fontWeight: 800, color: s.accent, letterSpacing: 0.5 }}>{s.num}</span>
                  </div>
                  <div style={{ fontWeight: 700, fontSize: "clamp(0.875rem, 1.8vw, 0.9375rem)", color: "#0F172A", marginBottom: 8 }}>{s.title}</div>
                  <div style={{ fontSize: "clamp(0.75rem, 1.5vw, 0.8rem)", color: "#64748B", lineHeight: 1.6 }}>{s.desc}</div>
                </div>
              ))}
            </div>
          </div>
      ...
      {/* ─── USE CASES ─── */}
      <section style={{ padding: "clamp(48px, 7vw, 72px) clamp(16px, 4vw, 32px)", background: "white" }}>
        <FadeIn>
          <div style={{ maxWidth: 1000, margin: "0 auto" }}>
            <h2 style={{
              fontSize: "clamp(1.375rem, 3.5vw, 1.875rem)",
              fontFamily: "'Instrument Serif', Georgia, serif",
              fontWeight: 400, color: "#0F172A", marginBottom: 12, letterSpacing: -0.3,
            }}>
              Built for businesses like yours
            </h2>
            <p style={{ color: "#94A3B8", fontSize: "clamp(0.875rem, 1.8vw, 0.9375rem)", marginBottom: 40 }}>
            ...
            <div style={{ display: "flex", flexWrap: "wrap", gap: 16 }}>
              {[
                ...
                <div key={i} style={{
                  ...
                  <div style={{ fontWeight: 700, fontSize: "clamp(0.875rem, 1.8vw, 0.9375rem)", color: "#0F172A", marginBottom: 6 }}>{c.title}</div>
                  <div style={{ fontSize: "clamp(1.125rem, 3vw, 1.5rem)", fontFamily: "'Instrument Serif', Georgia, serif", fontWeight: 400, color: "#0D9488", marginBottom: 6 }}>{c.stat}</div>
                  <div style={{ fontSize: "clamp(0.6875rem, 1.4vw, 0.75rem)", color: "#64748B", lineHeight: 1.5 }}>{c.desc}</div>
                </div>
              ))}
            </div>
          </div>
      ...
      {/* ─── PRICING ─── */}
      <section id="pricing" style={{ padding: "clamp(56px, 8vw, 80px) clamp(16px, 4vw, 32px)", background: "#F8FAFC" }}>
        <FadeIn>
          <div style={{ maxWidth: 1060, margin: "0 auto" }}>
            <div style={{ marginBottom: 44 }}>
              ...
              <p style={{ color: "#94A3B8", fontSize: "clamp(0.875rem, 1.8vw, 0.9375rem)", marginTop: 8 }}>Start free. Upgrade when the ROI is obvious.</p>
            </div>
            ...
            <p style={{ color: "#94A3B8", fontSize: "clamp(0.75rem, 1.5vw, 0.8125rem)", marginTop: 28 }}>
      ...
      {/* ─── SECURITY ─── */}
      <section style={{ padding: "clamp(32px, 5vw, 48px) clamp(16px, 4vw, 32px)" }}>
        <FadeIn>
          <div style={{
            ...
            <div style={{ flex: 1, minWidth: 240 }}>
              <div style={{
                fontFamily: "'Instrument Serif', Georgia, serif",
                fontWeight: 400, fontSize: "clamp(1rem, 2.5vw, 1.125rem)", color: "white", marginBottom: 6,
              }}>
                Built security-first, from the ground up
              </div>
              <div style={{ fontSize: "clamp(0.75rem, 1.5vw, 0.8125rem)", color: "rgba(255,255,255,0.45)", lineHeight: 1.7 }}>
      ...
      {/* ─── QUOTE FORM ─── */}
      <section id="quote" style={{ padding: "clamp(56px, 8vw, 80px) clamp(16px, 4vw, 32px)", background: "white" }}>
        <FadeIn>
          <div style={{ maxWidth: 560, margin: "0 auto" }}>
            ...
            {submitted ? (
              <div style={{
                ...
                padding: "clamp(40px, 7vw, 56px) 32px",
                ...
                <div style={{
                  ...
                  fontFamily: "'Instrument Serif', Georgia, serif",
                  fontWeight: 400, color: "#0F172A", marginBottom: 8,
                }}>You're in!</div>
                <div style={{ color: "#64748B", fontSize: "clamp(0.8125rem, 1.6vw, 0.875rem)", lineHeight: 1.6 }}>
                  We'll reach out on WhatsApp within 24 hours with your custom automation plan. No payment needed to start.
                </div>
              </div>
            ) : (
              <div style={{ background: "#F8FAFC", borderRadius: 20, padding: "clamp(24px, 4vw, 36px) clamp(20px, 3vw, 28px)", border: "1px solid #E2E8F0" }}>
                {errors.submit && (
                  <div style={{ background: "#FEF2F2", border: "1px solid #FECACA", borderRadius: 10, padding: "10px 14px", marginBottom: 14, color: "#DC2626", fontSize: "clamp(0.75rem, 1.5vw, 0.8125rem)" }}>
                    {errors.submit}
                  </div>
                )}
                <div style={{ display: "flex", flexWrap: "wrap", gap: 14, marginBottom: 14 }}>
                  {[
                    ...
                    <div key={f.key} style={{ flex: f.w }}>
                      <label htmlFor={`field-${f.key}`} style={{ fontSize: "clamp(0.6875rem, 1.4vw, 0.75rem)", fontWeight: 700, color: "#0F172A", display: "block", marginBottom: 5, textTransform: "uppercase", letterSpacing: 0.3 }}>
                        {f.label}
                      </label>
                      <input
                        id={`field-${f.key}`}
                        ...
                        style={{
                          ...
                          fontSize: "clamp(0.875rem, 1.8vw, 0.9375rem)", outline: "none",
                      ...
                      />
                      {errors[f.key] && (
                        <p id={`err-${f.key}`} role="alert" style={{ color: "#EF4444", fontSize: "clamp(0.6875rem, 1.4vw, 0.6875rem)", marginTop: 4 }}>{errors[f.key]}</p>
                      )}
                    </div>
                  ))}
                </div>
                <div style={{ marginBottom: 14 }}>
                  <p style={{ fontSize: "clamp(0.6875rem, 1.4vw, 0.75rem)", fontWeight: 700, color: "#0F172A", marginBottom: 5, textTransform: "uppercase", letterSpacing: 0.3 }}>
                    Business type
                  </p>
                  <div role="group" aria-label="Business type" style={{ display: "flex", flexWrap: "wrap", gap: 8 }}>
                    {["Salon", "Clinic", "Tutor", "Spa", "Travel", "Other"].map(t => (
                      <button
                        ...
                        style={{
                          padding: "8px 16px", borderRadius: 10, fontSize: "clamp(0.75rem, 1.5vw, 0.8125rem)", fontWeight: 600,
                  ...
                  {errors.type && (
                    <p role="alert" style={{ color: "#EF4444", fontSize: "clamp(0.6875rem, 1.4vw, 0.6875rem)", marginTop: 4 }}>{errors.type}</p>
                  )}
                </div>
                <div style={{ marginBottom: 18 }}>
                  <label htmlFor="field-message" style={{ fontSize: "clamp(0.6875rem, 1.4vw, 0.75rem)", fontWeight: 700, color: "#0F172A", display: "block", marginBottom: 5, textTransform: "uppercase", letterSpacing: 0.3 }}>
                  ...
                  <textarea
                    ...
                    style={{
                      width: "100%", padding: "12px 14px", borderRadius: 10,
                      border: "1px solid #E2E8F0", fontSize: "clamp(0.875rem, 1.8vw, 0.9375rem)",
                      outline: "none", fontFamily: "inherit", resize: "vertical",
                      background: "white", transition: "all 0.2s",
                    }}
                  />
                  <p style={{ textAlign: "right", fontSize: "clamp(0.6875rem, 1.4vw, 0.6875rem)", color: "#94A3B8", marginTop: 2 }}>
                ...
                <p style={{ textAlign: "center", fontSize: "clamp(0.6875rem, 1.4vw, 0.75rem)", color: "#94A3B8", marginTop: 10 }}>
      ...
      {/* ─── FOOTER ─── */}
      <footer style={{
        background: "#0F172A", padding: "clamp(32px, 5vw, 48px) clamp(16px, 4vw, 32px)",
        ...
        <div style={{ display: "flex", alignItems: "center", justifyContent: "center", gap: 10, marginBottom: 16 }}>
          ...
          <span style={{ fontWeight: 400, fontSize: "clamp(1rem, 2vw, 1.0625rem)", color: "white", fontFamily: "'Instrument Serif', Georgia, serif" }}>AutoFlow</span>
        </div>
        <div style={{ display: "flex", justifyContent: "center", gap: "clamp(12px, 3vw, 20px)", marginBottom: 16, flexWrap: "wrap" }}>
          <a href="#pricing" style={{ color: "rgba(255,255,255,0.4)", textDecoration: "none", fontSize: "clamp(0.75rem, 1.5vw, 0.8125rem)" }}>Pricing</a>
          <a href="#quote" style={{ color: "rgba(255,255,255,0.4)", textDecoration: "none", fontSize: "clamp(0.75rem, 1.5vw, 0.8125rem)" }}>Get a Quote</a>
          <a href={DASHBOARD_URL} style={{ color: "rgba(255,255,255,0.4)", textDecoration: "none", fontSize: "clamp(0.75rem, 1.5vw, 0.8125rem)" }}>Log in</a>
        </div>
        <div style={{ color: "rgba(255,255,255,0.3)", fontSize: "clamp(0.75rem, 1.5vw, 0.8125rem)", marginBottom: 6 }}>
          Automation services for businesses in the UAE
        </div>
        <div style={{ color: "rgba(255,255,255,0.2)", fontSize: "clamp(0.6875rem, 1.4vw, 0.75rem)" }}>© 2026 AutoFlow. All rights reserved.</div>
      </footer>
    </div>
  );
}
